...
tda998x_write_avi(struct tda998x_priv *priv, struct drm_display_mode *mode)
{
	...
	drm_hdmi_avi_infoframe_from_display_mode(&frame2, mode, false);
			      ...
			      const struct drm_display_mode *mode)
{
	...
	if (drm_hdmi_vendor_infoframe_from_display_mode(&frame2, mode))
...
#if 0
mode->clock=106500;
mode->vsync_start=925;
mode->vsync_end=931;
mode->vtotal=934;
mode->vdisplay=900;
mode->hsync_start=1520;
mode->hsync_end=1672;
mode->htotal=1904;
mode->hdisplay=1440;
...
#if 0
    mode->clock=148500;
    mode->vsync_start=1090;
    mode->vsync_end=1100;
    mode->vtotal=1110;
    mode->vdisplay=1080;
    mode->hsync_start=2010;
    mode->hsync_end=2100;
    mode->htotal=2190;
    mode->hdisplay=1920;
    adjusted_mode->flags=0x0a;
